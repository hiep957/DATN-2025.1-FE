...
import { Roles, sortOptions } from "../type";
            ...
            <div className="flex flex-col gap-4">
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 space-x-2">
                    ...
                    <div className="col-span-1 flex justify-end">
                        <Label className="sr-only">Vai trò</Label>
                        <Select value={role} onValueChange={(v) => set({ role: v === "all" ? undefined : v })}>
                ...
                <div className="grid grid-cols-5 gap-4">
                    <div className="col-span-1 text-sm flex items-center">Tìm thấy {total} người dùng</div>
                    <div>
